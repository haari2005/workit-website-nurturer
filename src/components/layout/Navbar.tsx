...
import { MobileThemeToggle } from '../theme/MobileThemeToggle';
...
const Navbar = () => {
  ...
  return (
    <header 
      ...
      ${scrolled 
        ? 'py-2 bg-white/80 backdrop-blur-lg shadow-sm dark:bg-black/80' 
        : 'py-4 bg-transparent'}`}
    >
      <div className="container-custom">
        ...
        {isOpen && (
          <div className="md:hidden absolute top-full left-0 right-0 bg-white/95 backdrop-blur-lg shadow-md animate-fade-in-up dark:bg-black/95">
